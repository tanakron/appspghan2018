                                ...
                                <div class="white-box">
                                    ...
                                    <h4>  Abstract category </h4>
                                     ...
                                     <h4>Abstract Title *</h4>
                                         ...
                                         <input type="text" class="md-input uk-form-width-medium" name="frmcontact_firstname" maxlength="25" size="100"/><br>
...
<input type="hidden" name="cust_id" value="" > 
                 ...
                 Only 1 table is allowed.  (*Time new roman font) &nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<input type="file" name="image1" value="" >(*.doc, .docx) 
