                                ...
                                <div class="white-box">
                                    ...
                                    <form action="cus_insert.php" method="post" enctype="multipart/form-data">
                                      ...
                                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size="2.5">(Abstract title should be less than 25 words in UPPER CASE.)</font>
                                         ...
                                         <br><br> <label>Type of Presentation*</label>
...
<!-- 
 ...
 <tr>
                                    ...
                                    <textarea name=frmab_background id=frmab_background style="width:96%;height:100px;" onkeypress="do_count();" onchange="do_count();" maxlength="60"></textarea>
                                    <label>Objectives: *</label>
                                <textarea name=frmab_objectives id=frmab_background style="width:96%;height:100px;" onkeypress="do_count();" onchange="do_count();"maxlength="60"></textarea>
                                    
                        <label>Materials Methods: * </label>
                                <textarea name=frmab_materialsmethods id=frmab_background style="width:96%;height:100px;" onkeypress="do_count();" onchange="do_count();"maxlength="60"></textarea>
                                <br>
                                  <label>Results: * </label>
                                <textarea name=frmab_results id=frmab_background style="width:96%;height:100px;" onkeypress="do_count();" onchange="do_count();"maxlength="75"></textarea>
                                <label>Conclusions: * </label>
                                <textarea name=frmab_conclusions id=frmab_background style="width:96%;height:100px;" onkeypress="do_count();" onchange="do_count();"maxlength="60"></textarea>
